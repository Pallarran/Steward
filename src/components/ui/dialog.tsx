...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-[16px] -mb-[16px] flex flex-col-reverse gap-[8px] rounded-b-[14px] border-t bg-muted/50 p-[16px] sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-[16px] leading-none font-medium",
        className
      )}
      {...props}
    />
